# SCP (SuperBlockChain Consensus Protocol)
...
XDR, in the file [SuperBlockChain-SCP.x](../xdr/SuperBlockChain-SCP.x)

The `snb-core` program has a single subclass of SCP called
...
For details of the protocol itself, see the [paper on SCP](https://www.snb.org/papers/snb-consensus-protocol.pdf).
