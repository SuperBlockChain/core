...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "SuperBlockChain Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.snb.org/papers/snb-consensus-protocol.pdf).
...
- Set of core validator nodes. Running snb-core only. Tasked with:
...
- Set of public HTTP nodes. Not running snb-core. Running
...
- (optional): Set of public validator nodes. Running snb-core only. Tasked
with:
  ...
  - Basically just a snb-network load balancer / firewall for public access,
