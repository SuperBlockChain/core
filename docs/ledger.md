...
- **Ledger**: A ledger is the state of the distributed SuperBlockChain database at a
...
- **Ledger header**: The ledger's header contains meta data about the ledger,
  ...
  own hash. (See [`src/xdr/SuperBlockChain-ledger.x`](/src/xdr/SuperBlockChain-ledger.x))


`SuperBlockChain-core` maintains the content of the latest ledger and of the ledger
...
performance needs.
 ...
 4. Finally, `snb-core` can be configured to upload detailed historical
