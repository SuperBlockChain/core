...
/* SuperBlockChainValue is the value used by SCP to reach consensus on a given ledger
*/
...
struct LedgerHeader
{
    ...
    SuperBlockChainValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from SuperBlockChainValue is normalized such that
