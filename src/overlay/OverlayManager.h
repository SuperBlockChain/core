 ...
 * `SuperBlockChainMessage`, in the file src/xdr/SuperBlockChain-overlay.x
 *
 ...
 *
 * The `SuperBlockChainMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    // Herder.
    virtual void broadcastMessage(SuperBlockChainMessage const& msg,
                                  bool force = false) = 0;
    ...
    virtual void recvFloodedMsg(SuperBlockChainMessage const& msg,
                                Peer::pointer peer) = 0;
