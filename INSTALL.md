...
==================
These are intructions for building snb-core from source. For a potentially quicker set up we also have snb-core in a docker container: https://github.com/snb/docker-snb-core-horizon
...
- `git clone https://github.com/snb/snb-core.git`
- `cd snb-core`
- `git submodule init`
