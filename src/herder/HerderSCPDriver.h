...
class HerderSCPDriver : public SCPDriver
{
  public:
    struct ConsensusData
    {
        ...
        SuperBlockChainValue mConsensusValue;
        ConsensusData(uint64_t index, SuperBlockChainValue const& b)
    ...
    void restoreSCPState(uint64_t index, SuperBlockChainValue const& value);
    ...
    void nominate(uint64_t slotIndex, SuperBlockChainValue const& value,
                  TxSetFramePtr proposedSet, SuperBlockChainValue const& previousValue);
  ...
  private:
    ...
    validateValueHelper(uint64_t slotIndex, SuperBlockChainValue const& sv) const;
