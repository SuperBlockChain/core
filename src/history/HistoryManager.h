 ...
 * stored at .well-known/snb-history.json as a JSON file.
 *
 ...
 *
 * While the _most recent_ checkpoint is in .well-known/snb-history.json,
...
class HistoryManager
{
  public:
    ...
    // .well-known/snb-history.json to it.
