...
*example: I tried to submit a transaction containing `createAccount` and then snb-core crashed*
...
*log location is normally defined in your log file something like `snb-core.log`*
