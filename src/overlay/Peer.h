             ...
             public NonMovableOrCopyable
{
  ...
  protected:
    ...
    void recvMessage(SuperBlockChainMessage const& msg);
    void recvMessage(AuthenticatedMessage const& msg);
    void recvMessage(xdr::msg_ptr const& xdrBytes);

    virtual void recvError(SuperBlockChainMessage const& msg);
    // returns false if we should drop this peer
    void noteHandshakeSuccessInPeerRecord();
    void recvAuth(SuperBlockChainMessage const& msg);
    void recvDontHave(SuperBlockChainMessage const& msg);
    void recvGetPeers(SuperBlockChainMessage const& msg);
    void recvHello(Hello const& elo);
    void recvPeers(SuperBlockChainMessage const& msg);

    void recvGetTxSet(SuperBlockChainMessage const& msg);
    void recvTxSet(SuperBlockChainMessage const& msg);
    void recvTransaction(SuperBlockChainMessage const& msg);
    void recvGetSCPQuorumSet(SuperBlockChainMessage const& msg);
    void recvSCPQuorumSet(SuperBlockChainMessage const& msg);
    void recvSCPMessage(SuperBlockChainMessage const& msg);
    void recvGetSCPState(SuperBlockChainMessage const& msg);
  ...
  public:
    ...
    void sendMessage(SuperBlockChainMessage const& msg);
