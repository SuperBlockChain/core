...
Note that you can (and should) install the Windows version of postgres even when running snb-core from within WSL.
...
- Open the solution `Builds\VisualStudio\snb-core.sln`
